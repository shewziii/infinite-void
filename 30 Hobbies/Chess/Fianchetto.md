...
![fianchetto|680x680](https://images.chesscomfiles.com/uploads/v1/images_users/tiny_mce/PedroPinhata/phpZtoUOM.png)

Black's dark-squared bishop is fianchettoed in the King's Indian Defense.

The King's Indian Defense is a dynamic opening that allows White to create a large center with the aim of attacking it later. This defense has been a favorite of many world champions, including GMs [Garry Kasparov](https://www.chess.com/players/garry-kasparov) and [Bobby Fischer](https://www.chess.com/players/bobby-fischer).

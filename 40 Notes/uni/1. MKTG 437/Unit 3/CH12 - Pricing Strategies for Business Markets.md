...
[[Cost drivers]] create value by providing economic savings, and [[revenue drivers]] add incremental value by facilitating revenue or margin requirements.
## Elasticity Varies by Market Segment
Price elasticity measures how sensitive customers are to price changes. [[Price elasticity of demand]] is the rate of percentage change in quantity demanded to percentage change in price.

Things that can influence price elasticity of demand include:
- flexibility of customers in comparing alternatives and switching suppliers
	- satisfied customers are less price sensitive
- importance of the product in the cost structure of the customer's product
- value that a product represents to a customer
- switching costs
- end market focus
	- since demand for industrial products is derived from the demand for the product of which they are a part, strong end user focus is needed
## Cost Determinants
...
Establishing the correct launch price of a product or service can reset market price expectations and boost the profit trajectory across the remainder of that offering's life cycle.

[[Skimming]] is a pricing approach where a high initial price is charged, which provides the firm with the opportunity to profitably reach market segments that are not sensitive to high initial prices. This approach is appropriate for distinctly new products and enables the marketer to capture early profits and gives the innovator a chance to recover high research and development costs more quickly. Eventually the marketer can reduce price to target more price sensitive segments.

[[Penetration]] pricing is when you charge a very low initial price, and is appropriate when there is a high price elasticity of demand, strong threat of imminent competition, and an opportunity for a substantial production cost reduction as volume expands.
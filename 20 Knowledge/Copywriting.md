**Table of Contents**
- [[#Basic Sales Psychology|Basic Sales Psychology]]
	- [[#Basic Sales Psychology#Emotional Cores|Emotional Cores]]
	- [[#Basic Sales Psychology#Desires|Desires]]
		- [[#Desires#Promises|Promises]]
		- [[#Desires#What makes a good promise?|What makes a good promise?]]
	- [[#Basic Sales Psychology#Prospect state of awareness|Prospect state of awareness]]
	- [[#Basic Sales Psychology#Stages of awareness|Stages of awareness]]
		- [[#Stages of awareness#Stage 1: Most aware|Stage 1: Most aware]]
		- [[#Stages of awareness#Stage 2: Product aware|Stage 2: Product aware]]
		- [[#Stages of awareness#Stage 3: Solution aware|Stage 3: Solution aware]]
		- [[#Stages of awareness#Stage 4: Problem aware|Stage 4: Problem aware]]
		- [[#Stages of awareness#Stage 5: Unaware|Stage 5: Unaware]]
	- [[#Basic Sales Psychology#The "new" test|The "new" test]]
	- [[#Basic Sales Psychology#Notions|Notions]]
	- [[#Basic Sales Psychology#Identifications|Identifications]]
	- [[#Basic Sales Psychology#Characteristics|Characteristics]]
	- [[#Basic Sales Psychology#Coming up with good ideas|Coming up with good ideas]]
- [[#Copywriting Research|Copywriting Research]]
- [[#Writing Copy|Writing Copy]]
- [[#Editing and Revising Your Copy|Editing and Revising Your Copy]]
- [[#Finding Work as a Copywriter|Finding Work as a Copywriter]]

## Basic Sales Psychology

People make decisions based on emotions. While the logical part of their minds says one thing, the emotional part is what drives those decisions. Once an emotional decision is made, our logical mind will try to justify that decision in any way it can before trying to negate that decision.

We have 4 areas that make up a person's emotional core: 
- Desires
- Notions
- Identifications
- Characteristics
...
Desires are the goals that drive a person. I.E. what a person wants. Notions are beliefs about the world around the person. Identifications are the labels they give themselves. People tie a lot of their beliefs and interests to their identities. Characteristics are just the attributes people have. Bald, body fat %, etc.

### Desires

If you can appeal to a person's desires, you can get them to buy almost anything. there are two types of desires:
...
The key with this audience is to identify anything they could possibly be interested in. Anything that will lead them to read the first paragraph of your copy will be effective, and each preceding paragraph should influence your audience to read the next one. 

You most likely will never write for this stage of awareness.

---
To figure out which stage of awareness a prospect or audience is in, ask these questions:

1. Does your prospect consciously know they have a problem or a desire? If yes, they're not "**unaware**."
2. Does your prospect know that there's a solution to their problem or a way to achieve their desires? If yes, they're not "**problem aware**."
3. Does your prospect already know the product you're selling by name or know similar products by name? If yes, they're not "**solution aware**."
4. Does your prospect know the price of the product you're selling already, or are they looking for any reason they can to by the product that you're selling? If yes, they're "**most aware**."

---
### The "new" test
If an ad makes the same promise as a multitude of others, it drives the chance of people opening it to the ground. Take the line, "make money online fast." It's everywhere, but it's not new. If you want it to stand out, you have to make a promise that is specific, new, or big.

Be careful with overpromising. If a promise is too big, it can look absurd and you'll look like a fool.

>[!quote] Eugene Schwartz
>"If your market is at the stage where they've heard all the claims, in all their extremes, then mere repetition or exaggeration won't work any longer. What this market needs now is a new devices to make all these old claims become fresh and believable to them again. In other words, a new mechanism—a new way to make the old promise work. A different process—a fresh chance—a brand new possibility of success where only disappointment has resulted before."

### Notions

How people perceive the world around them. They can be political views, morals, or general ideas about how the world works. There are two types of notions:

- Firm notions
- Shakable notions

Firm notions are those that the prospect holds dear and cannot be convinced to let go of. Shakable notions are those the prospect holds but would be happy to be wrong about.

Knowing what notions your reader has can help you write copy that 's more powerful than just focusing on desires. 

The simplest tool you can use when it comes to making the most out of notions is acknowledgement. 

### Identifications

Humans love to label themselves, and will always love being part of a group. If your copy targets a group that signals exclusivity, they will respond more positively to it. 

>[!example] Expert tips for beginner swimmers

Another tool you can use is mimicking. Intentionally using the language of your prospect in relation to the group they identify with is a great way to grab their attention. If you speak their language, they are far more likely to like you and trust your message.

### Characteristics

The traits people don't get to choose. Some characteristics can act like identifications for the prospect. Only bring these into your copy if the opportunity is obvious to include. 

---
### Coming up with good ideas

An idea is the core assertion of your copy—the main point you want your prospect to take on board. 

If your prospect is in an unaware state, you can grab their attention by hinting at or teasing a hidden problem that prospects did not even know they or, or a problem happening in society that they might not know about.

The goal of an ad that uses an idea to appeal to prospects is to hold their attention long enough to work your way back to the product and your pitch.

The most indirect way to appeal to them with an idea is with a story.

>[!Important] Your job as a copywriter is to  come up with good ideas that will make your copy more impactful for the prospect, instead of solely relying on simple tools like promises and gimmicks.

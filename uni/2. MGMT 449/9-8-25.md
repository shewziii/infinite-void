...
# What is Strategy?
Strategy is a company's coordinated set of actions that its managers take in order to outperform the company's competitors and achieve superior profitability.
...
- Is deciding to compete differently - pressuring rivals by doing what they do not do or, even better, doing what they cannot do.
- Provides guidance in what it must do and also what it must not do.
- Is successful when its actions, business approaches, and competitive moves appeal to buyers in ways that: 
    - Set it apart from its rivals by through higher perceived values or efficiently producing at lower costs 
    - Stake out a market position that is not crowded 
...
- Develop expertise and long term capabilities that cannot be readily overcome
...
- By providing customers with value 
    - The firm's customer value proposition
        - The reason a customer would choose you over another company
...
- Is it likey to result in a sustainable competitive advantage?
...
![[Pasted image 20250908174628.png]]
...
- Should focus on describing the firm's business, not on "making a profit"

> [!note] Earning a profit is an objective, not a mission

# Mission vs. Vision
A strategic vision describes a firm's aspirations for its future (answers the questions - "where are we going")

A firm's mission depicts its purpose and its current business (answers the questions "who we are, what we do, and why we are here")

> [!note] Vision describes the future, Mission describes the now
...
They become an integral part of the firm's culture and what makes it tick when strongly espoused and supported by top management
They match the firm's vision, mission, and strategy, contributing to the firm's business success
> [!note] Core values link the vision and mission
...
# Converting Objectives to Performance Targets 
...
- Push a firm to be more intentive
...
- Creates an exciting work environment and attract the best people
- Help prevent internal inertia and contentment with modest gains in performance 

# Balanced Scoreboard
A balanced scoreboard strives to place:
...
- The 4 dimensions of a Balanced scoreboard:
1. Financial objectives 
2. Strategic objectives that signal greater competitive strength (and thus greater capability to achieve higher levels of financial performance)
...
![[Pasted image 20250908184326.png]]
